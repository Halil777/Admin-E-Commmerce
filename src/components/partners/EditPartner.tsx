...
const updatePartner = async (partnerId: string, data: FormData) => {
  const response = await fetch(`${BASE_URL}partners/${partnerId}`, {
    method: "PATCH",
    body: data,
  });
  ...
  useEffect(() => {
    const loadPartner = async () => {
      if (location.state?.partner) {
        setInputObject(location.state.partner);
      } else if (partnerId) {
        setIsLoading(true);
        try {
            ...
            <div className="flex gap-x-2">
              ...
              >
                ...
                <span className="dark:text-whiteSecondary text-blackPrimary font-medium">
                  Update Partner {/* Changed button text */}
                </span>
              </button>
            </div>
          </div>
          ...
          <div className="px-4 sm:px-6 lg:px-8 pb-8 pt-8 grid grid-cols-2 gap-x-10 max-xl:grid-cols-1 max-xl:gap-y-10">
            <div>
              ...
              <div className="mt-4 flex flex-col gap-5">
                <InputWithLabel label="Title (Turkmen)">
                  <SimpleInput
                    type="text"
                    placeholder="Enter title in Turkmen..."
                ...
                <InputWithLabel label="Title (Russian)">
                  <SimpleInput
                    type="text"
                ...
                <InputWithLabel label="Title (English)">
                  <SimpleInput
                    type="text"
